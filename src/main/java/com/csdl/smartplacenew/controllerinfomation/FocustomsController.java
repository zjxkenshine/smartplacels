...
import com.csdl.smartplacenew.informationvo.FocustomsVo;
import com.csdl.smartplacenew.mapper.FocustomsMapper;
...
@Api(description = "民俗风情")
@RestController
@RequestMapping("/Focustoms")
public class FocustomsController {


    @Resource
    FocustomsMapper focustomsMapper;

    @Resource
    UserMapper userMapper;

    @ApiOperation(value = "添加民俗风情", notes = "")
    @ApiImplicitParams({
    ...
    private ResultVO add(@ApiParam("file") MultipartFile file, HttpServletRequest request) throws IOException {
        ...
        if(file!=null) {
            ...
            String fileRealPath = ConfigBean.sourceRealPath + "information" + File.separator + "Focustoms" + File.separator;
            ...
            String imgVirtualPath = ConfigBean.sourceVirtualPath + "information/" + "Focustoms/" + filename;
            focustomsMapper.addFocustoms(name, imgVirtualPath, 1,currentUserId,type1,abbreviation);
        }else{
            focustomsMapper.addFocustoms(name, null, 1,currentUserId,type1,abbreviation);
        }

        Focustoms focustoms=focustomsMapper.getFocustomsByMaxId(currentUserId);

        return ResultVOUtil.success(focustoms);
    ...
    @ApiOperation(value = "添加民俗风情内容", notes = "")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "民俗风情id", required = true, dataType = "integer", paramType = "query"),
    ...
    private void addTxt( HttpServletRequest request) throws IOException {
        ...
        String filepath =  ConfigBean.sourceRealPath+"txt"+ File.separator+"Focustoms"+File.separator;
        ...
        String filepath2=  ConfigBean.sourceRealPath+"txt"+ File.separator+"Focustoms"+File.separator+"Focustoms"+id+".txt";
    ...
    @ApiOperation(value = "上传民俗风情内容文件", notes = "")
    @ApiImplicitParams({
    ...
    private String addTxtFile(@ApiParam("file") MultipartFile file, HttpServletRequest request) throws IOException {
        ...
        String filepath2=  ConfigBean.sourceRealPath+"informapict"+ File.separator+"Focustoms"+File.separator;
        ...
        String realPath= ConfigBean.sourceVirtualPath+"informapict/"+"Focustoms/"+filename;
    ...
    @ApiOperation(value = "修改民俗风情内容", notes = "")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "民俗风情id", required = true, dataType = "integer", paramType = "query"),
            @ApiImplicitParam(name = "txt", value = "内容", required = true, dataType = "string", paramType = "query"),
    })
    ...
    private void updateTxt( HttpServletRequest request) throws IOException {
        ...
        String filepath =  ConfigBean.sourceRealPath+"txt"+ File.separator+"Focustoms"+File.separator+"Focustoms"+id+".txt";
    ...
    @ApiOperation(value = "查询民俗风情", notes = "")
    @ApiImplicitParams({
    ...
    private ResultVO getList1(HttpServletRequest request) throws IOException {
        ...
        if(name!=null&&!name.equals("")){
            ...
            Integer count=focustomsMapper.getFocustomsCount("%"+name+"%",type,currentUserId);

            PageHelper.startPage(page,size);

            List<Focustoms> focustomsList=focustomsMapper.selectFocustoms2("%"+name+"%",type,currentUserId);

            List<FocustomsVo> focustomsVoArrayList=new ArrayList<>();

            for(int i=0;i<focustomsList.size();i++){

                Focustoms focustoms=focustomsList.get(i);

                FocustomsVo focustomsVo=new FocustomsVo();
...
//                BufferedReader br = new BufferedReader(reader); // 建立一个对象，它把文件内容转成计算机能读懂的语言
                ...
                focustomsVoArrayList.add(focustomsVo);

            }

            ListVO listVO=new ListVO();
            listVO.setCount(count);
            listVO.setList(focustomsVoArrayList);
            ...
            Integer count=focustomsMapper.getFocustomsCount(null,type,currentUserId);

            PageHelper.startPage(page,size);

            List<Focustoms> focustomsList=focustomsMapper.selectFocustoms2(null,type,currentUserId);
...
//                BufferedReader br = new BufferedReader(reader); // 建立一个对象，它把文件内容转成计算机能读懂的语言
    ...
    @ApiOperation(value = "删除民俗风情内容", notes = "")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "民俗风情id", required = true, dataType = "integer", paramType = "query"),
    ...
    private ResultVO del( HttpServletRequest request) throws IOException {
        ...
        focustomsMapper.delFocustoms(id,currentUserId);
    ...
    private ResultVO update(@ApiParam("file") MultipartFile file, HttpServletRequest request) throws IOException {
        ...
        Focustoms focustoms=focustomsMapper.getFocustomsById2(id,currentUserId);
        ...
        if(file!=null) {
            ...
            if (focustoms.getPictureurl() != null) {

                if(focustoms.getPictureurl()!=null&&!focustoms.getPictureurl().equals("")) {
                    String[] strings = focustoms.getPictureurl().split("\\/");

                    File file1 = new File(ConfigBean.sourceRealPath + "information" + File.separator + "Focustoms" + File.separator + strings[5]);
            ...
            focustomsMapper.updateFocustoms(name, imgVirtualPath, type1,abbreviation,id,currentUserId);

            Focustoms focustoms2 = focustomsMapper.getFocustomsById2(id,currentUserId);


            return ResultVOUtil.success(focustoms2);
            ...
            focustomsMapper.updateFocustoms(name,focustoms.getPictureurl(),type1,abbreviation,id,currentUserId);

            Focustoms focustoms3=focustomsMapper.getFocustomsById2(id,currentUserId);


            return  ResultVOUtil.success(focustoms3);
