...
import com.csdl.smartplacenew.informationvo.StangeogrnamesVo;
import com.csdl.smartplacenew.mapper.StangeogrnamesMapper;
...
@Api(description = "标准地名录")
@RestController
@RequestMapping("/Stangeogrnames")
public class StangeogrnamesController {



    @Resource
    StangeogrnamesMapper  stangeogrnamesMapper;

    @Resource
    UserMapper userMapper;


    @ApiOperation(value = "添加标准地名录", notes = "")
    @ApiImplicitParams({
    ...
    private ResultVO add(@ApiParam("file") MultipartFile file, HttpServletRequest request) throws IOException {
        ...
        if(file!=null) {
            ...
            String fileRealPath = ConfigBean.sourceRealPath + "information" + File.separator + "Stangeogrnames" + File.separator;
            ...
            String imgVirtualPath = ConfigBean.sourceVirtualPath + "information/" + "Stangeogrnames/" + filename;
            stangeogrnamesMapper.addStangeogrnames(name, imgVirtualPath, 1,currentUserId);
        }
        else{
            stangeogrnamesMapper.addStangeogrnames(name, null, 1,currentUserId);
        }


        Stangeogrnames stangeogrnames=stangeogrnamesMapper.getStangeogrnamesByMaxId(currentUserId);


        return ResultVOUtil.success(stangeogrnames);
    ...
    @ApiOperation(value = "添加标准地名录内容", notes = "")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "标准地名录id", required = true, dataType = "integer", paramType = "query"),
    ...
    private void addTxt( HttpServletRequest request) throws IOException {
        ...
        String filepath =  ConfigBean.sourceRealPath+"txt"+ File.separator+"Stangeogrnames"+File.separator;
        ...
        String filepath2=  ConfigBean.sourceRealPath+"txt"+ File.separator+"Stangeogrnames"+File.separator+"Stangeogrnames"+id+".txt";
    ...
    @ApiOperation(value = "上传标准地名录内容文件", notes = "")
    @ApiImplicitParams({
    ...
    private String addTxtFile(@ApiParam("file") MultipartFile file, HttpServletRequest request) throws IOException {
        ...
        String filepath2=  ConfigBean.sourceRealPath+"informapict"+ File.separator+"Stangeogrnames"+File.separator;
        ...
        String realPath= ConfigBean.sourceVirtualPath+"informapict/"+"Stangeogrnames/"+filename;
    ...
    @ApiOperation(value = "修改标准地名录内容", notes = "")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "标准地名录id", required = true, dataType = "integer", paramType = "query"),
            @ApiImplicitParam(name = "txt", value = "内容", required = true, dataType = "string", paramType = "query"),
    })
    ...
    private void updateTxt( HttpServletRequest request) throws IOException {
        ...
        String filepath =  ConfigBean.sourceRealPath+"txt"+ File.separator+"Stangeogrnames"+File.separator+"Stangeogrnames"+id+".txt";
    ...
    @ApiOperation(value = "查询标准地名录", notes = "")
    @ApiImplicitParams({
    ...
    private ResultVO getList1(HttpServletRequest request) throws IOException {
        ...
        if(name!=null&&!name.equals("")){
            ...
            Integer count=stangeogrnamesMapper.getStangeogrnamesCount("%"+name+"%",currentUserId);

            PageHelper.startPage(page,size);

            List<Stangeogrnames> stangeogrnamesList=stangeogrnamesMapper.selectStangeogrnames2("%"+name+"%",currentUserId);
...
//                BufferedReader br = new BufferedReader(reader); // 建立一个对象，它把文件内容转成计算机能读懂的语言
            ...
            Integer count=stangeogrnamesMapper.getStangeogrnamesCount(null,currentUserId);

            PageHelper.startPage(page,size);

            List<Stangeogrnames> stangeogrnamesList=stangeogrnamesMapper.selectStangeogrnames2(null,currentUserId);
    ...
    @ApiOperation(value = "删除标准地名录内容", notes = "")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "标准地名录id", required = true, dataType = "integer", paramType = "query"),
    ...
    private ResultVO del( HttpServletRequest request) throws IOException {
        ...
        stangeogrnamesMapper.delStangeogrnames(id,currentUserId);
    ...
    private ResultVO update(@ApiParam("file") MultipartFile file, HttpServletRequest request) throws IOException {
        ...
        Stangeogrnames stangeogrnames=stangeogrnamesMapper.getStangeogrnamesById2(id,currentUserId);
        ...
        if(file!=null) {
            ...
            if(stangeogrnames.getPictureurl()!=null){

                if(stangeogrnames.getPictureurl()!=null&&!stangeogrnames.getPictureurl().equals("")) {
                    String[] strings = stangeogrnames.getPictureurl().split("\\/");

                    File file1 = new File(ConfigBean.sourceRealPath + "information" + File.separator + "Stangeogrnames" + File.separator + strings[5]);
                ...
                stangeogrnamesMapper.updateStangeogrnames(name,imgVirtualPath,id,currentUserId);

                Stangeogrnames stangeogrnames1=stangeogrnamesMapper.getStangeogrnamesById2(id,currentUserId);

                return  ResultVOUtil.success(stangeogrnames1);
                ...
                String imgVirtualPath=ConfigBean.sourceVirtualPath+"information/"+"NolegStangeogrnamesaculture/"+filename;
            ...
            stangeogrnamesMapper.updateStangeogrnames(name,stangeogrnames.getPictureurl(),id,currentUserId);
